...
Датасеты CIFAR10 и CIFAR100 аналогичны, разница между ними заключается в количестве детектируемых классов, поэтому в своих экспериментах я использовал CIFAR10.
...
##### Первые выводы:
* Чем больше скрытый слой тем ниже loss и качество изображений становится более схожими
...
* Использование скрытого слоя автоэнкодера не подходит для задачи классификации, потому что скрытый слой хранит информацию обо всем изображении (объект, фон).
...
* Возможность обучать двух-головую сеть, 1 на автоэнкодер, 2 на классификацию
* Добавление детектирование объекта (для минимизации фона)
